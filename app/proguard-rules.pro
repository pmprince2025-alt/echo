...
-keep class prince.sonic.music.models.PersistQueue { *; }
-keep class prince.sonic.music.models.PersistPlayerState { *; }
-keep class prince.sonic.music.models.QueueData { *; }
-keep class prince.sonic.music.models.QueueType { *; }
-keep class prince.sonic.music.playback.queues.** { *; }
...
-keep class prince.sonic.music.listentogether.proto.** { *; }
-keepclassmembers class prince.sonic.music.listentogether.proto.** { *; }
...
## Keep App Classes
-keep class prince.sonic.music.** { *; }
-keep interface prince.sonic.music.** { *; }

## Keep all model classes
-keep class prince.sonic.music.models.** { *; }
-keep class prince.sonic.music.db.entities.** { *; }
...
-keep class prince.sonic.music.playback.MusicService {
    <init>();
    *** player;
    *** mediaSession;
    *** database;
...
-keep class prince.sonic.music.playback.ExoDownloadService {
    <init>();
    *** onCreate();
    *** onDestroy();
    public *** *;
