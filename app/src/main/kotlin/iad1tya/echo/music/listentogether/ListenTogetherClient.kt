...
package prince.sonic.music.listentogether
...
import prince.sonic.music.constants.ListenTogetherAutoApproveSuggestionsKey
import prince.sonic.music.constants.ListenTogetherIsHostKey
import prince.sonic.music.constants.ListenTogetherRoomCodeKey
import prince.sonic.music.constants.ListenTogetherServerUrlKey
import prince.sonic.music.constants.ListenTogetherSessionTimestampKey
import prince.sonic.music.constants.ListenTogetherSessionTokenKey
import prince.sonic.music.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient
    ...
    constructor(
        ...
        companion object {
            ...
            const val ACTION_APPROVE_JOIN = "prince.sonic.music.LISTEN_TOGETHER_APPROVE_JOIN"
            const val ACTION_REJECT_JOIN = "prince.sonic.music.LISTEN_TOGETHER_REJECT_JOIN"
            const val ACTION_APPROVE_SUGGESTION = "prince.sonic.music.LISTEN_TOGETHER_APPROVE_SUGGESTION"
            const val ACTION_REJECT_SUGGESTION = "prince.sonic.music.LISTEN_TOGETHER_REJECT_SUGGESTION"
        ...
        private fun loadBlockedUsernames() {
            try {
                val blockedJson = context.dataStore.get(prince.sonic.music.constants.ListenTogetherBlockedUsersKey, "")
                val blockedList =
        ...
        private suspend fun saveBlockedUsernames() {
            try {
                ...
                context.dataStore.edit { preferences ->
                    preferences[prince.sonic.music.constants.ListenTogetherBlockedUsersKey] = blockedJson
                }
            } catch (e: Exception) {
