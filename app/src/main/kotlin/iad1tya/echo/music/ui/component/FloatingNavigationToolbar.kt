...
private fun floatingToolbarContainerColor(pureBlack: Boolean): Color {
    return if (pureBlack) Color.Black.copy(alpha = 0.75f) else MaterialTheme.colorScheme.surfaceContainer.copy(alpha = 0.55f)
}
...
private fun floatingToolbarSelectedItemContainerColor(pureBlack: Boolean): Color {
    ...
    return if (pureBlack) primaryColor.copy(alpha = 0.22f) else primaryColor.copy(alpha = 0.15f)
}
