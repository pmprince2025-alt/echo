...
fun RotatingCD(
    ...
    Box(
        ...
        Box(
            modifier = Modifier
                .fillMaxSize(0.90f)
                .border(1.5dp, Color.White.copy(alpha = 0.04f), CircleShape)
        )
        Box(
            modifier = Modifier
                .fillMaxSize(0.85f)
        ...
        Box(
            ...
            Box(
                modifier = Modifier
                    .fillMaxSize()
                    .border(1.5dp, Color.Black.copy(alpha = 0.15f), CircleShape)
            )
        }

        // CD / Vinyl Shimmer/Sweeping reflections
        Box(
            modifier = Modifier
                .fillMaxSize()
                .background(
        ...
        Box(
            modifier = Modifier
                ...
                .border(2.dp, Color(0xFFC0C0C0).copy(alpha = 0.4f), CircleShape)
        ) {
            Box(
                modifier = Modifier
                    .fillMaxSize(0.4f)
